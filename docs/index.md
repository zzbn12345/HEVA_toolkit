...
HEVA helps researchers turn color-annotated PDF and DOCX documents into validated, reusable
heritage annotation data.

Read these pages in order:

1. [Install and run HEVA](INSTALLATION.md)
