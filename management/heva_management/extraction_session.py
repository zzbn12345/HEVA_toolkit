...
from management.heva_management.contract import ContractIssue, validate_record
from management.heva_management.project_registry import (
    ...
    *,
    ...
    if source.suffix.lower() == ".pdf":
        try:
            ...
            raise ExtractionSessionError(
                "PDF extraction is optional. Install extraction/requirements.txt first."
            ) from error
