...
Usage examples:
- python -m src.validate_records --file data/Galle_P127_extracted.json
- python -m src.validate_records --all
- python -m src.validate_records --glob "data/*_extracted.json"
"""
