...
Usage examples:
- python -m heva.workflow.validate_records --file data/Galle_P127_extracted.json
- python -m heva.workflow.validate_records --all
- python -m heva.workflow.validate_records --glob "data/*_extracted.json"
"""
