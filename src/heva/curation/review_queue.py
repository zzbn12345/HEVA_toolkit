...
from heva.curation.extraction_draft import ExtractionDraftError, load_extraction_draft
...
from heva.curation.review_state import DocumentReview
...
def submit_review_document(
    ...
    *,
    ...
    from heva.curation.curation_state import create_candidate_snapshot
    from heva.curation.review_state import submit_document_for_review
